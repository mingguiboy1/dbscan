...
class DBSCAN private (
  ...
  private def train(vectors: RDD[(Vector,Array[String])]): DBSCAN = {
  ...
  private def toMinimumBoundingRectangle(vector: (Vector,Array[String])): DBSCANRectangle = {
